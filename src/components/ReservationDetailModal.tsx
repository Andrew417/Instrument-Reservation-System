    ...
    >
      <div className="bg-white sm:rounded-2xl sm:border sm:border-stone-200 shadow-2xl w-full sm:max-w-2xl z-10 flex flex-col h-full sm:h-auto sm:max-h-[92vh] overflow-hidden pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
        ...
        {activeTab === "details" ? (
          <div className="p-4 sm:p-6 overflow-y-auto overscroll-contain space-y-4 flex-1 min-h-0">
            ...
            >
              ...
              {!isOutsideChurch ? (
                <div className="flex items-center gap-2 text-xs text-emerald-900 bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2">
                ...
                <>
                  ...
                  {!isAdminViewer &&
                    ...
                    paymentSettings?.instapayLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between gap-2 w-full h-11 px-4 bg-purple-700 hover:bg-purple-800 text-white text-sm font-bold rounded-xl transition cursor-pointer"
                      >
                  ...
                  {isAdminViewer && (
                    <div className="flex items-center gap-2 text-[11px] text-stone-600 bg-stone-100 border border-stone-200 rounded-lg px-3 py-2">
            ...
            {/* Payment screenshot — minimal: preview + change/delete icon buttons */}
            {isOutsideChurch && (isAdminViewer || isApprovedOutsideChurch) && (
              <div className="rounded-2xl border border-purple-200 bg-purple-50/40 p-4 space-y-3">
                ...
                {hasAnyScreenshot ? (
                  <div className="space-y-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`block relative rounded-xl overflow-hidden border bg-white ${
                    ...
                    {isPendingOnly && (
                      <div className="flex items-center gap-1.5 text-[11px] text-sky-800 bg-sky-50 border border-sky-200 rounded-lg px-2.5 py-1.5">
                    ...
                    {!isAdminViewer && (
                      <div className="flex items-center justify-end gap-2">
                        <label
                          ...
                          className="w-9 h-9 flex items-center justify-center rounded-lg bg-white border border-stone-300 text-stone-600 hover:bg-stone-50 cursor-pointer"
                        ...
                        <button
                          ...
                          className="w-9 h-9 flex items-center justify-center rounded-lg bg-red-50 border border-red-200 text-red-700 hover:bg-red-100 disabled:opacity-50 cursor-pointer"
                          title={
                  ...
                  <div className="rounded-xl border-2 border-dashed border-purple-300 bg-white p-4 text-center">
                  ...
                  <label
                    ...
                    onDrop={handleDrop}
                    className={`block rounded-xl border-2 border-dashed p-5 text-center space-y-1.5 cursor-pointer transition ${
                      dragActive
                  ...
                  >
                    {uploadingScreenshot ? (
                      ...
                      <Upload className="w-6 h-6 text-purple-700 mx-auto" />
                    )}
                    <p className="text-xs font-bold text-stone-800">
                ...
                {screenshotSuccess && (
                  <div className="flex items-center gap-1.5 text-[11px] text-emerald-800 bg-emerald-50 border border-emerald-200 rounded-lg px-2.5 py-1.5">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-xl p-3 space-y-2.5">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 h-9 bg-white border border-stone-300 text-stone-700 text-xs font-bold rounded-lg cursor-pointer disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        disabled={isDeletingScreenshot}
                        className="flex-1 h-9 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-lg flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
                      >
              ...
              <div className="bg-red-50 border border-red-200 rounded-2xl p-4 space-y-3">
                ...
                {isAdminViewer && (
                  <div className="space-y-2">
                    <select
                      ...
                      className="w-full h-10 px-3 bg-white border border-red-200 rounded-xl text-sm text-stone-900"
                    >
                    ...
                    {cancelReasonPreset === "Other" && (
                      <textarea
                        ...
                        className="w-full px-3 py-2 bg-white border border-red-200 rounded-xl text-sm resize-none"
                      />
                    )}
                  </div>
                )}
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 h-10 bg-stone-200 hover:bg-stone-300 text-stone-800 text-sm font-bold rounded-xl cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 h-10 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-xl flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
                  >
                    {isCancelling ? (
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                    ) : (
        ...
        {activeTab === "details" && showFooter && (
          <div className="px-3 py-2.5 pb-[max(8px,env(safe-area-inset-bottom))] bg-white border-t border-stone-200 shrink-0 flex items-center gap-2">
            {showReject && (
              <button
                type="button"
                onClick={() => setIsRejectOpen(true)}
                disabled={isApproving || isRejecting}
                className="flex-1 h-11 bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 text-sm font-bold rounded-xl flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
              >
                <XCircle className="w-4 h-4" />
            ...
            {showApprove && (
              <button
                ...
                disabled={isApproving || isRejecting}
                className="flex-1 h-11 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-xl flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
              >
                {isApproving ? (
                  <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                ) : (
            ...
            {showCancel && (
              <button
                ...
                disabled={isCancelling}
                className={`h-11 bg-white hover:bg-red-50 text-red-700 border border-red-200 text-sm font-bold rounded-xl flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer ${
                  showSavePayment ? "flex-1" : "flex-1"
                }`}
              >
                <Trash2 className="w-4 h-4" />
            ...
            {showSavePayment && (
              <button
                ...
                className={`flex-1 h-11 text-sm font-bold rounded-xl transition flex items-center justify-center gap-2 cursor-pointer ${
            ...
            {showNoShowToggle && (
              <button
                ...
                className={`flex-1 h-11 text-sm font-bold rounded-xl flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer ${
                  canUnmarkNoShow
