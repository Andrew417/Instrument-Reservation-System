...
async function runComprehensiveTests() {
  ...
  try {
    ...
    console.log('Created pending reservation:', single.reservation.id, single.reservation.status);
    ...
    const approvedByAdmin = await adminApproveReservation(pendingBooking.reservation.id, adminUser.id);
    ...
    console.log('Admin rejected status:', rejectedByAdmin.status, 'Reason:', rejectedByAdmin.rejectionReason);
